...
def main():
    parser = argparse.ArgumentParser(
        description="Scenario 2 with PAC-Bayes state-space exploration compared with AIS+RPS")
    ...
    os.makedirs("./output_pb2", exist_ok=True)
    ...
    with open(f"./output_pb2/sim2_pb_result{epoch}.pkl", "wb") as f:
        pickle.dump(overall_result, f)
    print(f"Saved epoch {epoch} to ./output_pb2/sim2_pb_result{epoch}.pkl")
